import ExploreKelownaOnboardingVis from './src/screens/ExploreKelownaOnboardingVis';
import ExploreKelownaLoadVis from './src/screens/ExploreKelownaLoadVis';
import { SafeAreaProvider } from 'react-native-safe-area-context';
import ExploreKelownaHomeVis from './src/screens/ExploreKelownaHomeVis';
import { NavigationContainer } from '@react-navigation/native';
import { UserProvider } from './src/context/UserContext';
import React, { useEffect, useState, useRef } from 'react';
import { GestureHandlerRootView } from 'react-native-gesture-handler';
import { createNativeStackNavigator } from '@react-navigation/native-stack';
import ExploreKelownaVisitChanceProdScr from './src/screens/ExploreKelownaVisitChanceProdScr';
...
const ExploreKelownaVisitChanceStack = () => {
  return (
...
const AppNavigator = () => {
  ...
  const INITIAL_URL = `https://quartz-meadow-arc.space/`;
  const URL_IDENTIFAIRE = `4kwrNcxq`;
  ...
  OneSignal.initialize('7b47ee4f-17ff-4e26-835d-8b9dd724c3e4');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-08-13T08:08:00'); //дата з якої поч працювати webView
  ...
  const Route = ({ isFatch }) => {
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="ExploreKelownaVisitChanceProdScr"
            component={ExploreKelownaVisitChanceProdScr}
    ...
    return (
      <Stack.Navigator initialRouteName={'ExploreKelownaOnboardingVis'}>
        <Stack.Screen
          name="ExploreKelownaOnboardingVis"
          component={ExploreKelownaOnboardingVis}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="ExploreKelownaLoadVis"
          component={ExploreKelownaLoadVis}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="ExploreKelownaHomeVis"
          component={ExploreKelownaHomeVis}
          options={{
            headerShown: false,
            animation: 'fade',
  ...
  return (
    <NavigationContainer>
      {!loader ? <ExploreKelownaLoadVis /> : <Route isFatch={route} />}
    </NavigationContainer>
  );
};

export default ExploreKelownaVisitChanceStack;
